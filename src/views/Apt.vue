    ...
    <v-container>
      <v-row>
        <v-col>
          ...
          <v-btn style="margin-left: 10px" @click="searchApt">아파트별 검색</v-btn>
        </v-col>
      </v-row>
      ...
      <v-row>
        <v-col cols="12" align="center" style="min-height: 200px">
          <!-- 주위 여러 정보 -->
          <apt-around-info
            :sido="selectSido"
            :sidoname="sidoName"
...
import AptAroundInfo from "@/components/apt/AptAroundInfo.vue";
...
export default {
  ...
  data() {
    return {
      headers: [
        { text: "아파트명", align: "start", value: "아파트" },
        { text: "법정동", value: "법정동" },
        { text: "층수", value: "층" },
        { text: "거래금액(천원)", value: "거래금액" },
        { text: "건축년도", value: "건축년도" },
